...
public class MainDemoTest {
    ...
    public void testMain() throws Exception {
    	...
    	Assert.assertFalse(MainDemo.safehomeConsole.hashCode()==sc.hashCode());
    	Assert.assertFalse(MainDemo.controlPanel.hashCode()==cp.hashCode());
    	Assert.assertFalse(MainDemo.user.hashCode()==u.hashCode());
    }
